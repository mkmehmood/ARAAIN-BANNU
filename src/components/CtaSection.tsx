          ...
          <div className="rounded-3xl p-8 sm:p-10 bg-gradient-to-br from-[#16232F] to-[#1E3040] text-white shadow-xl flex flex-col justify-between relative overflow-hidden border border-white/10 min-h-[360px]">
            ...
            <div className="relative z-10">
              <button
                ...
                className="w-full sm:w-auto h-12 inline-flex items-center justify-center gap-2 px-6 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm sm:text-base shadow-lg transition-all duration-200 hover:scale-[1.02] active:scale-95 cursor-pointer"
              >
          ...
          <div className="rounded-3xl p-8 sm:p-10 bg-gradient-to-br from-[#2A1E0E] to-[#3B2912] text-white shadow-xl flex flex-col justify-between relative overflow-hidden border border-[#AD7A28]/30 min-h-[360px]">
            ...
            <div className="relative z-10">
              <button
                ...
                className="w-full sm:w-auto h-12 inline-flex items-center justify-center gap-2 px-6 rounded-xl bg-[#AD7A28] hover:bg-[#C89238] text-white font-bold text-sm sm:text-base shadow-lg shadow-amber-950/40 transition-all duration-200 hover:scale-[1.02] active:scale-95 cursor-pointer"
              >
